                ...
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-6 border border-indigo-100">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Advanced AI Engine</p>
                    </div>
                  </div>
            ...
            <div className="bg-gradient-to-br from-purple-600 to-indigo-600 rounded-xl shadow-lg p-6 text-white">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold">Advanced AI Engine</p>
                    <p className="text-sm text-purple-200">Natural Language Processing</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-purple-200">Data Intelligence Platform</p>
                  </div>
                </div>
              </div>
            </div>
